...
class Main extends PluginBase
{
    ...
    public $enchants = [
        ...
        CustomEnchantsIds::ANTIKNOCKBACK => ["Anti Knockback", "Armor", "Damage", "Rare", 30, "Reduces knockback by 25% per armor piece"],
        CustomEnchantsIds::ANTITOXIN => ["Antitoxin", "Helmets", "Effect", "Mythic", 30, "Immunity to poison"],
        CustomEnchantsIds::AERIAL => ["Aerial", "Weapons", "Damage", "Common", 30, "Increases damage in air"],
        CustomEnchantsIds::ARMORED => ["Armored", "Armor", "Damage", "Rare", 30, "Decreases sword damage by 20l%"],
        CustomEnchantsIds::AUTOREPAIR => ["Autorepair", "Damageable", "Move", "Uncommon", 30, "Automatically repairs items when moving"],
        CustomEnchantsIds::BACKSTAB => ["Backstab", "Weapons", "Damage", "Uncommon", 30, "When hitting from behind, you deal more damage."],
        CustomEnchantsIds::BERSERKER => ["Berserker", "Armor", "Damaged", "Rare", 30, "Gives strength on low health"],
        CustomEnchantsIds::BLESSED => ["Blessed", "Weapons", "Damage", "Uncommon", 30, "15l% (l = level) chance to remove bad effects"],
        CustomEnchantsIds::BLAZE => ["Blaze", "Bow", "Shoot", "Rare", 30, "Shoots fireballs"],
        CustomEnchantsIds::BLIND => ["Blind", "Weapons", "Damage", "Common", 30, "Gives enemies blindness"],
        CustomEnchantsIds::BOUNTYHUNTER => ["Bounty Hunter", "Bow", "Damage", "Uncommon", 30, "Collect bounties (items) when hitting enemies."],
        CustomEnchantsIds::CACTUS => ["Cactus", "Armor", "Equip", "Rare", 30, "Poke people around you", "Poke people around you"],
        CustomEnchantsIds::CHARGE => ["Charge", "Weapons", "Damage", "Uncommon", 30, "Increases damage when sprinting"],
        CustomEnchantsIds::CHICKEN => ["Chicken", "Chestplate", "Equip", "Uncommon", 30, "Lays egg every 5 minutes, 5l% (l = level) chance of rare drop"],
        CustomEnchantsIds::CLOAKING => ["Cloaking", "Armor", "Damaged", "Uncommon", 30, "Becomes invisible when hit"],
        CustomEnchantsIds::CRIPPLINGSTRIKE => ["Cripple", "Weapons", "Damage", "Common", 30, "Gives enemies nausea and slowness"],
        CustomEnchantsIds::CRIPPLE => ["Cripple", "Weapons", "Damage", "Common", 30, "Gives enemies nausea and slowness"],
        CustomEnchantsIds::CURSED => ["Cursed", "Armor", "Damaged", "Uncommon", 30, "Gives wither to enemy when hit"],
        CustomEnchantsIds::DEATHBRINGER => ["Deathbringer", "Weapons", "Damage", "Rare", 30, "Increases damage"],
        CustomEnchantsIds::DISARMING => ["Disarming", "Weapons", "Damage", "Uncommon", 30, "10l% chance to disarm enemy"],
        CustomEnchantsIds::DISARMOR => ["Disarmor", "Weapons", "Damage", "Uncommon", 30, "10l% chance to disarmor enemy"],
        CustomEnchantsIds::DRILLER => ["Driller", "Tools", "Break", "Uncommon", 30, "Breaks a 3 by 3 by 1 + level"],
        CustomEnchantsIds::DRUNK => ["Drunk", "Armor", "Damaged", "Rare", 30, "Gives slowness, mining fatigue, and nausea to enemy when hit"],
        CustomEnchantsIds::ENDERSHIFT => ["Endershift", "Armor", "Damaged", "Rare", 30, "Gives speed and extra health when low on health"],
        CustomEnchantsIds::ENERGIZING => ["Energizing", "Tools", "Break", "Uncommon", 30, "Gives haste when block is broken"],
        CustomEnchantsIds::ENLIGHTED => ["Enlighted", "Armor", "Damaged", "Uncommon", 30, "Gives regeneration when hit"],
        CustomEnchantsIds::ENRAGED => ["Enraged", "Chestplate", "Equip", "Rare", 30, "Strength per level"],
        CustomEnchantsIds::EXPLOSIVE => ["Explosive", "Tools", "Break", "Rare", 30, "Cause an explosion when block is broken"],
        CustomEnchantsIds::FARMER => ["Farmer", "Hoe", "Break", "Uncommon", 30, "Automatically regrows crops when harvested"],
        CustomEnchantsIds::FERTILIZER => ["Fertilizer", "Hoe", "Interact", "Uncommon", 30, "Creates farmland in a level radius around the block"],
        CustomEnchantsIds::FOCUSED => ["Focused", "Helmets", "Effect", "Uncommon", 30, "Nausea will affect you less"],
        CustomEnchantsIds::FORCEFIELD => ["Forcefield", "Armor", "Equip", "Mythic", 30, "Deflects projectiles and living entities in a 0.75x (x = # of armor pieces)"],
        CustomEnchantsIds::FROZEN => ["Frozen", "Armor", "Damaged", "Rare", 30, "Gives slowness to enemy when hit"],
        CustomEnchantsIds::GEARS => ["Gears", "Boots", "Equip", "Uncommon", 30, "Gives speed"],
        CustomEnchantsIds::GLOWING => ["Glowing", "Helmets", "Equip", "Common", 1, "Gives night vision"],
        CustomEnchantsIds::GOOEY => ["Gooey", "Weapons", "Damage", "Uncommon", 30, "Flings enemy into the air"],
        ...
        CustomEnchantsIds::HALLUCINATION => ["Hallucination", "Weapons", "Damage", "Mythic", 30, "5l% (l = level) chance of trapping enemies in a fake prison"],
        ...
        CustomEnchantsIds::OVERLOAD => ["Overload", "Armor", "Equip", "Mythic", 30, "Gives 1 extra heart per level per armor piece"],
        ...
        CustomEnchantsIds::PIERCING => ["Piercing", "Bow", "Damage", "Rare", 30, "Ignores armor when dealing damage"],
        CustomEnchantsIds::POISON => ["Poison", "Weapons", "Damage", "Uncommon", 30, "Poisons enemies"],
        CustomEnchantsIds::POISONED => ["Poisoned", "Armor", "Damaged", "Uncommon", 30, "Poisons enemy when hit"],
        ...
        CustomEnchantsIds::SPRINGS => ["Springs", "Boots", "Equip", "Uncommon", 30, "Gives a jump boost"],
        CustomEnchantsIds::STOMP => ["Stomp", "Boots", "Fall_Damage", "Uncommon", 30, "Deal part of fall damage to enemy when taking fall damage"],
        CustomEnchantsIds::TANK => ["Tank", "Armor", "Damage", "Uncommon", 30, "Spawn TNT when you die."],
        CustomEnchantsIds::TELEPATHY => ["Telepathy", "Tools", "Break", "Rare", 30, "Automatically puts drops in inventory."],
        CustomEnchantsIds::VACUUM => ["Vacuum", "Chestplate", "Equip", "Rare", 30, "Suck up items in a 3l radius"],
        CustomEnchantsIds::VAMPIRE => ["Vampire", "Weapons", "Damage", "Uncommon", 30, "Heals by part of damage dealt"],
        CustomEnchantsIds::VOLLEY => ["Volley", "Bow", "Shoot", "Uncommon", 5, "Shoot multiple arrows in a cone"],
        CustomEnchantsIds::WITHER => ["Wither", "Weapons", "Damage", "Uncommon", 30, "Gives enemies wither"],
        CustomEnchantsIds::WITHERSKULL => ["Wither Skull", "Bow", "Shoot", "Mythic", 30, "Shoots Wither Skull"]
    ];
